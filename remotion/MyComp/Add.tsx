...
export const Add: React.FC = () => {
  return (
    <div
      className="w-full h-full p-24 relative overflow-hidden block z-10
      ...
      <ul style={{ fontSize: "3em", listStyle: "none" }}>
        <TransitionSeries>
          ...
          <TransitionSeries.Sequence durationInFrames={300} className="">
            ...
            <li>
              {" "}
              Address : Best Courter Room no 9, SV road, Santacruz (W), 400054.{" "}
            </li>
            <li>
              {" "}
              Permanent Address: At Sabalewadi, post. Umbraj, Tal. Karad, Dist.
              Satara (415109).{" "}
            </li>
